...
function fn1() {
  const result = get_1$1({ a: 'fn1' }, 'a');
  console.log(result);
}

function fn2() {
  const result = get_1$1({ a: 'fn2' }, 'a');
  console.log(result);
}

function fn3() {
  const result = get_1$1({ a: 'fn3' }, 'a');
  console.log(result);
}

function fn4() {
  const result = get_1$1({ a: 'fn4' }, 'a');
  console.log(result);
}

function fn5() {
  const result = get_1$1({ a: 'fn5' }, 'a');
  console.log(result);
}

function fn6() {
  const result = get_1$1({ a: 'fn6' }, 'a');
  console.log(result);
}

function fn7() {
  const result = get_1$1({ a: 'fn7' }, 'a');
  console.log(result);
}

function fn9() {
  const result = get_1$1({ a: 'fn9' }, 'a');
  console.log(result);
}

function fn8() {
  const result = get_1$1({ a: 'fn8' }, 'a');
  console.log(result);
